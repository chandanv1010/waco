...
// Cac trang tinh cua WACO. Phai khai bao o day (truoc route dong {canonical})
// vi noi dung nam trong bang introduces chu khong phai mot ban ghi co router.
Route::get('/gioi-thieu.html', [\App\Http\Controllers\Frontend\AboutController::class, 'index'])->name('about.index');
Route::get('/he-thong-dai-ly.html', [\App\Http\Controllers\Frontend\DealerNetworkController::class, 'index'])->name('dealer.network');
