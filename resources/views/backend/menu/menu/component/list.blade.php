<div class="row">
    ...
    <div class="col-lg-8">
        <div class="ibox">
            <div class="ibox-content">
                @php
                    $isLevel1 = isset($config['method']) && $config['method'] !== 'children';
                @endphp
                <div class="row">
                    <div class="{{ $isLevel1 ? 'col-lg-3' : 'col-lg-4' }}">
                        <div class="text-bold">Tên Menu</div>
                    </div>
                    <div class="{{ $isLevel1 ? 'col-lg-3' : 'col-lg-4' }}">
                        <div class="text-bold">Đường dẫn</div>
                    </div>
                    @if($isLevel1)
                        <div class="col-lg-3">
                            <div class="text-bold">Icon (Menu cấp 1)</div>
                        </div>
                    @endif
                    <div class="{{ $isLevel1 ? 'col-lg-1' : 'col-lg-2' }}">
                        <div class="text-bold">Vị trí</div>
                    </div>
                    <div class="col-lg-2 text-center">
                        <div class="text-bold">Xóa</div>
                    </div>
                </div>
                                ...
                                @if($isLevel1)
                                    <div class="col-lg-3">
                                        <input 
                                            ...
                                            name="menu[icon][]"
                                            placeholder="Chọn Icon (Menu cấp 1)"
                                            readonly
                                        >
                                    </div>
                                @endif
