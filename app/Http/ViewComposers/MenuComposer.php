        ...
        return [
            ...
            'relation' => [
                'menus' => function($query) use ($language) {
                    // Sap xep TANG dan theo `order`: menu nhap trong admin duoc
                    // danh so 0,1,2... theo thu tu mong muon. De 'desc' nhu ma
                    // nguon goc thi menu hien nguoc - "Lien he" len dau, "Trang
                    // chu" xuong cuoi.
