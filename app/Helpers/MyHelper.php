...
if (!function_exists('youtube_id')) {
    /**
     * Tach ma video YouTube tu o "Video YouTube" cua san pham.
     *
     * Quan tri co the dan nhieu kieu khac nhau nen nhan tat:
     *   - link thuong      https://www.youtube.com/watch?v=ABC123
     *   - link rut gon     https://youtu.be/ABC123
     *   - link nhung       https://www.youtube.com/embed/ABC123
     *   - link short       https://www.youtube.com/shorts/ABC123
     *   - ca the <iframe>  (lay src ben trong)
     *   - chi rieng ma     ABC123
     *
     * Tra ve chuoi rong neu khong nhan ra - de giao dien bo qua muc video thay
     * vi nhung mot khung trang.
     */
    function youtube_id(?string $input): string
    {
        ...
        // Ma video YouTube luon la 11 ky tu chu, so, gach ngang hoac gach duoi.
        if (preg_match('~^[A-Za-z0-9_-]{11}$~', $input)) {
            return $input;
        }

        if (preg_match('~(?:youtube\.com/(?:watch\?(?:.*&)?v=|embed/|shorts/|v/)|youtu\.be/)([A-Za-z0-9_-]{11})~', $input, $khop)) {
            return $khop[1];
        }
